const CACHE='lantern-public-v1';
const ASSETS=['/offline.html','/icons/icon-192.png','/icons/icon-512.png','/images/blue-cathedral.webp','/images/crimson-citadel.webp','/images/office-practice.webp'];
